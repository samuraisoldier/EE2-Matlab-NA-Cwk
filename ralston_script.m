...
[ta,Vout]=ralston(func,t0,i0,tf,h,Vin,R);
...
grid on
grid minor
title('Vout/t for RL circuit with \itVin is sawtooth with T=25\mus')
xlabel('0 < t < 50\mus')
ylabel('Voltage')
hold on;
plot(ta,Vin,'b');
...
grid on
grid minor
title('Vout/t for RL circuit with \itVin is sawtooth with T=550\mus')
xlabel('0 < t < 1100\mus')
ylabel('Voltage')
hold on;
plot(ta,Vin,'b');
...
grid on
grid minor
title('Vout/t for RL circuit with \itVin is sawtooth with T=1200\mus')
xlabel('0 < t < 2400\mus')
ylabel('Voltage')
hold on;
plot(ta,Vin,'b');
